// pages/privacy-policy-terms-of-service.js
"use client";
...
const PrivacyPolicyTermsOfService = () => {
  return (
    <>
      <Head>
        <title>Privacy Policy & Terms of Service - Tatacookies</title>
        <meta
          name="description"
          content="Read Tatacookies' privacy policy and terms of service. Learn how we protect your personal information and our service terms for custom cookie orders in Sydney."
        />
        <meta name="robots" content="index, follow" />
        <link
          rel="canonical"
          href="https://tatacookies.com/privacy-policy-terms-of-service"
        />
      </Head>
        ...
        <SectionWrapper>
          <div className="max-w-3xl px-6 py-10 mx-auto text-text leading-6">
            ...
            <ul className="list-disc pl-6 mb-6">
              ...
              <li>
                Order info: event theme, quantity, delivery method, budget,
                notes
              </li>
            ...
            <ul className="list-disc pl-6 mb-6">
              ...
              <li>
                We share data only with trusted providers like email, payments,
            ...
            <p className="mb-6">
              We use cookies and tools like Google Analytics to understand
              visitor behavior and improve our site. You can control cookies via
            ...
            <p className="mb-6">
              ...
              begins. We use secure third-party payment providers such as
              Stripe.
            </p>
            ...
            <p className="mb-6">
              While we do our best to avoid allergens, our cookies may contain
              or come into contact with wheat, nuts, soy, eggs, or dairy.
            </p>
            ...
            <p className="mb-6">
              ...
              product designs—is the property of Tatacookies and may not be
            ...
            <p className="mb-6">
              ...
              website or the consumption of our products, to the extent
